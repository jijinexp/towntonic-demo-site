  ...
  return (
    <div className="py-16 px-4 max-w-5xl mx-auto font-sans">
      ...
      <div className="border-t border-stone-200 pt-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-stone-500 font-medium text-sm">
          <div className="bg-stone-50 p-6 border border-stone-100 rounded-sm">
            ...
            <p className="text-xs text-stone-400">Weekly Single-Origin beans</p>
          </div>
          <div className="bg-stone-50 p-6 border border-stone-100 rounded-sm">
            <h4 className="text-primary font-bold mb-1">Akaroa Harbor Harvests</h4>
            <p className="text-xs text-stone-400">Sustainably caught blue cod</p>
          </div>
          <div className="bg-stone-50 p-6 border border-stone-100 rounded-sm">
            <h4 className="text-primary font-bold mb-1">Canterbury Organic Farms</h4>
            <p className="text-xs text-stone-400">Fresh heirloom tomatoes & herbs</p>
          </div>
          <div className="bg-stone-50 p-6 border border-stone-100 rounded-sm">
            <h4 className="text-primary font-bold mb-1">Lincoln Orchard Guild</h4>
            <p className="text-xs text-stone-400">Seasonal apples, pears & honey</p>
          </div>
        </div>
      </div>
    </div>
